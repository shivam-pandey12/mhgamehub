import { FINAL_STEP, HOME_ENTRY_STEP, LAST_TRACK_STEP, PLAYER_META } from './constants.js';
...
export function getCellForSteps(playerId, steps) {
  ...
  return {
    ...
    playerId,
    steps,
    laneIndex: Math.min(steps - HOME_ENTRY_STEP, 5),
    cell: getHomeLaneCell(playerId, steps - HOME_ENTRY_STEP)
  };
}
