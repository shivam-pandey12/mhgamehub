...
void main() {
	...
	`}var jo=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var ay={currentPlayer:document.querySelector(`#current-player`),turnChip:document.querySelector(`#turn-chip`),phaseChip:document.querySelector(`#phase-chip`),roundChip:document.querySelector(`#round-chip`),statusText:document.querySelector(`#status-text`),scorePlayer1:document.querySelector(`#score-player-1`),scorePlayer2:document.querySelector(`#score-player-2`),roundsPlayer1:document.querySelector(`#rounds-player-1`),roundsPlayer2:document.querySelector(`#rounds-player-2`),boardScorePlayer1:document.querySelector(`#board-score-player-1`),boardScorePlayer2:document.querySelector(`#board-score-player-2`),duePlayer1:document.querySelector(`#due-player-1`),duePlayer2:document.querySelector(`#due-player-2`),queenStatus:document.querySelector(`#queen-status`),roundStatus:document.querySelector(`#round-status`),modeSelect:document.querySelector(`#mode-select`),difficultySelect:document.querySelector(`#difficulty-select`),restartButton:document.querySelector(`#restart-button`),soundButton:document.querySelector(`#sound-button`),cameraButton:document.querySelector(`#camera-button`),rulesButton:document.querySelector(`#rules-button`),rulesPanel:document.querySelector(`#rules-panel`),powerFill:document.querySelector(`#power-fill`),hintText:document.querySelector(`#hint-text`)},oy=new ry({container:document.querySelector(`#scene-shell`),ui:ay});window.__carromGame=oy;