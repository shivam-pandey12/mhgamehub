...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$i,depthTest:!1,depthWrite:!1})}function rc(){return new Qi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:$i,depthTest:!1,depthWrite:!1})}function oc(){return new Qi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:$i,depthTest:!1,depthWrite:!1})}function Xo(){return`
